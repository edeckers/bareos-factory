...
[![Bareos](https://img.shields.io/badge/Bareos-24.0.10-green)](https://github.com/bareos/bareos)
...
| Image                                                                          | Description                               |
|--------------------------------------------------------------------------------|-------------------------------------------|
| [`edeckers/bareos-dir:24.0.10`](https://hub.docker.com/r/edeckers/bareos-dir)   | Bareos Director                           |
| [`edeckers/bareos-fd:24.0.10`](https://hub.docker.com/r/edeckers/bareos-fd)     | Bareos File Daemon                        |
| [`edeckers/bareos-sd:24.0.10`](https://hub.docker.com/r/edeckers/bareos-sd)     | Bareos Storage Daemon                     |
| [`edeckers/bareos-deps:24.0.10`](https://hub.docker.com/r/edeckers/bareos-deps) | `.deb` packages for all Bareos components |
...
docker run --rm \
  ...
  -e PGDATABASE=bareos \
  edeckers/bareos-dir:24.0.10 db:init
...
docker run -d \
  ...
  edeckers/bareos-dir:24.0.10
```

### File Daemon

```bash
docker run -d --name bareos-fd edeckers/bareos-fd:24.0.10
```

### Storage Daemon

```bash
docker run -d --name bareos-sd edeckers/bareos-sd:24.0.10
```
...
|----------|---------|-------------|
| `BF_BAREOS_VERSION` | `24.0.10` | Bareos version to build |
...
```bash
docker run -d --user root --name bareos-fd edeckers/bareos-fd:24.0.10
```
